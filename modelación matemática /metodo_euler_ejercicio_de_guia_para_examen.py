"""
                    Código escrito por Leobardo de jesús carbajal (Lechuguita)
                    Código para resolver mediante el método de euler el ejercicio 3 de la guía de practica 
                    para el primer examen argumentativo.
                    como firma a todos mis codigos o la mayoria los resultados los imprimo en color verde utilizando 
                    la funcion colored de la libreria termcolor
"""
#Código comentado en su mayoria para una buena redacción y un buen entendimiento del mismo :)
