...
public:
    ...
    void graba() {
        std::ofstream arch("alumnos.csv", std::ios::app); //std::ofstream: Clase para crear y escribir en archivos. // std::ios::app: Modo de apertura de archivo que coloca el puntero de escritura al final del archivo
        if (!arch) {
